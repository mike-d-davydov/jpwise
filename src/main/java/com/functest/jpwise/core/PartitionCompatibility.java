 ...
 * This class provides a modern Predicate-based approach for defining compatibility rules.
 */
public final class PartitionCompatibility {
    ...
    /**
     * Creates a compatibility predicate that checks if both partitions satisfy their respective conditions.
     * If a condition is null, it is treated as always true for that partition.
     *
    ...
    /**
     * Creates a compatibility predicate that checks if the left partition satisfies a condition.
     * The right partition is always considered compatible.
     *
     ...
     */
    public static CompatibilityPredicate leftSatisfies(Predicate<EquivalencePartition<?>> conditionForLeft) {
        return conditionsHold(conditionForLeft, null);
    }

    /**
     * Creates a compatibility predicate that checks if the right partition satisfies a condition.
     * The left partition is always considered compatible.
     *
     ...
     */
    public static CompatibilityPredicate rightSatisfies(Predicate<EquivalencePartition<?>> conditionForRight) {
