...
/**
 * Base class for equivalence partitions.
 * An equivalence partition represents a set of values that are considered equivalent
...
public abstract class BaseEquivalencePartition<T> implements EquivalencePartition<T> {
    ...
    /**
     * Gets the value of this equivalence partition.
