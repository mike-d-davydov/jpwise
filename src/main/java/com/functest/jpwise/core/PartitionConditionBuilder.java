...
/**
 * A fluent builder for creating complex predicates that match EquivalencePartition instances. This
 * builder allows chaining multiple conditions using a readable, fluent API.
 *
 * <p>Example usage:
 *
 * <pre>
