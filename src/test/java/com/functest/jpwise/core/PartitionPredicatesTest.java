...
public class PartitionPredicatesTest {
  ...
  @Test
  public void testAnd() {
    Predicate<EquivalencePartition<?>> chromeInBrowser =
        and(nameIs("Chrome"), parameterNameIs("browser"));
  ...
  @Test
  public void testOr() {
    Predicate<EquivalencePartition<?>> chromeOrFirefox = or(nameIs("Chrome"), nameIs("Firefox"));
  ...
  public void testComplexPredicate() {
    ...
    Predicate<EquivalencePartition<?>> complexPredicate =
        and(
