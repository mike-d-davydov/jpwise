...
public class CombinationTableTest {
    ...
    public void testAsRowMapList() {
        ...
        assertTrue(row1.containsKey("combination_description"), "Should include combination description");
        ...
        assertTrue(row2.containsKey("combination_description"), "Should include combination description");
    }
    ...
    public void testAsDataProvider() {
        ...
        // Check first row
        Object[] row1 = data[0];
        assertTrue(row1[0].toString().contains("Chrome"), "First element should be combination description");
        ...
        // Check second row
        Object[] row2 = data[1];
        assertTrue(row2[0].toString().contains("Firefox"), "First element should be combination description");
    ...
    public void testToString() {
        assertEquals(table.toString(), "CombinationTable{0 combinations.}", 
            "Should format empty table correctly");

        table.add(combination1);
        assertTrue(table.toString().contains("1 combinations"), 
            "Should include combination count");
        assertTrue(table.toString().contains("Chrome"), 
            "Should include first combination details");
    }
