...
public class JPWiseTest {
    ...
    public void testInlineParameterCreationWithRules() {
        ...
        CombinationTable results = JPWise.builder()
            .parameter("browser", Arrays.<EquivalencePartition<?>>asList(chrome, firefox, safari), rules)
            .parameter("os", Arrays.<EquivalencePartition<?>>asList(windows, macOS, linux), Arrays.<CompatibilityPredicate>asList())
            .generatePairwise();
