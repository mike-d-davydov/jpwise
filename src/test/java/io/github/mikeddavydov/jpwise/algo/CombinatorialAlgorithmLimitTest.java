...
public class CombinatorialAlgorithmLimitTest {
        ...
        public void testCombinatorialGenerationWithDifferentLimits(int limit) {
                ...
                CombinationTable result = JPWise.builder()
                                ...
                                .parameter("Browser",
                                                Arrays.asList(
                                                                CyclingPartition.of("Chrome",
                                                                                Arrays.asList("latest", "previous")),
                ...
                System.out.printf("Combination limit %d generated %d combinations in %d ms%n",
        ...
        private void verifyCompatibilityRules(Combination combination) {
                ...
                if (colorDepth.equals("10-bit")) {
                        assertEquals(resolution, "3840x2160",
                                        "10-bit color depth should only be paired with 4K resolution");
                }
        }
}