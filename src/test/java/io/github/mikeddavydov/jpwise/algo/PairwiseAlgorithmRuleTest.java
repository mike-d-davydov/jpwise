...
public class PairwiseAlgorithmRuleTest {
        ...
        public void testPairwiseGenerationWithRules() {
                JPWise.InputBuilder builder = JPWise.builder()
                                .parameter("Browser",
                                                Arrays.<EquivalencePartition>asList(
                                                                SimpleValue.of("Chrome"),
                                                                SimpleValue.of("Firefox"),
                                                                SimpleValue.of("Safari")),
                                                Arrays.asList((ep1, ep2) -> { // ep1: Browser, ep2: Other
                                                        if (ep1.getName().equals("Safari") && ep2.getParentParameter()
                                                                        .getName().equals("OS")) {
                                                                return ep2.getName().equals("macOS");
                                                        }
                                                        return true;
                                                }))
                                .parameter("OS", // OS rule can be empty if Browser's rule covers it due to symmetric
                                                 // check
                                                Arrays.<EquivalencePartition>asList(
                                ...
                                .parameter("Device",
                                                ...
                                                Arrays.asList((ep1, ep2) -> { // ep1: Device, ep2: Other
                                ...
                                .parameter("Resolution", // Resolution rules can be empty if other params cover them
                                                Arrays.<EquivalencePartition>asList(
                                                                SimpleValue.of("1920x1080"),
                                                                SimpleValue.of("3840x2160")), // This is 4K
                                                new ArrayList<>())
                                .parameter("ColorDepth",
                                                Arrays.<EquivalencePartition>asList(
                                                                SimpleValue.of("8-bit"),
                                                                SimpleValue.of("10-bit")),
                                                Arrays.asList((ep1, ep2) -> { // ep1: ColorDepth, ep2: Other
                                ...
                                .parameter("Timezone",
                                                Arrays.<EquivalencePartition>asList(
                                                                SimpleValue.of("UTC+0"),
                                                                SimpleValue.of("UTC+2")),
                                                new ArrayList<>())
                                .parameter("Theme",
                                                Arrays.<EquivalencePartition>asList(
                ...
                for (Combination combination : table.combinations()) {
                        ...
                        if (browser.equals("Safari")) {
                                org.testng.Assert.assertEquals(os, "macOS",
                                                "Safari (" + browser + ") should only be paired with macOS, not " + os);
                        }

                        // Verify Mobile-4K rule
                        if (device.equals("Mobile")) {
                                org.testng.Assert.assertNotEquals(resolution, "3840x2160",
                        ...
                        if (colorDepth.equals("10-bit")) {
                                org.testng.Assert.assertEquals(resolution, "3840x2160",
                                                "10-bit color depth (" + colorDepth
