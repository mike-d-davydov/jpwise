...
public class RulePreprocessorTest {
        ...
        public void testRulePropagation() {
                ...
                TestInput input = JPWise.builder()
                                .parameter(TestParameter.of("Browser",
                                                Arrays.asList(
                                                                SimpleValue.of("Chrome"),
                                                                SimpleValue.of("Firefox"),
                                                                SimpleValue.of("Safari")),
                                                Arrays.asList((ep1, ep2) -> { // ep1: Browser partition, ep2: Other
                                ...
                                .parameter(TestParameter.of("OS",
                                                Arrays.asList(
                                                                SimpleValue.of("Windows"),
                                                                SimpleValue.of("macOS"))))
                                .parameter(TestParameter.of("Device",
                                                Arrays.asList(
                ...
                assertTrue(osParam.getDependencies().containsAll(browserParam.getDependencies()),
